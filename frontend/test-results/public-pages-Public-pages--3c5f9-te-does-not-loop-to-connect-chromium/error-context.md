...
- Name: public-pages.spec.ts >> Public pages without a wallet >> dashboard disconnected empty state does not loop to connect
- Location: tests\e2e\public-pages.spec.ts:23:7

# Error details

```
Error: Wave 6 /dashboard
