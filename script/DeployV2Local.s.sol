...
/// @dev forge script script/DeployV2Local.s.sol:DeployV2Local --rpc-url http://127.0.0.1:8545 --broadcast --via-ir --unlocked --sender 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --disable-code-size-limit
contract DeployV2Local is DeployV2Base, SeedV2Anvil {
    ...
    function run() external {
        ...
        seedDirectAnvil(d.directFactory, d.faucet);
